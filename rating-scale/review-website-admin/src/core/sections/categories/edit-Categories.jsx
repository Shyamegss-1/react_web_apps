...
export default function EditCategoriess({
  open,
  setOpen,
  setData,
  selectedOption,
        ...
        <Stack height="100%" component="form" justifyContent="space-between">
          <Box>
            <Typography variant="h6">
              {data && data?.name?.split(" ")[0]}&prime;s information
            </Typography>
            ...
            <Grid mt={7} container justifyContent="space-between">
              <Grid item xs={4}>
                <div style={{ display: "grid", rowGap: "0.7rem" }}>
                  ...
                  <StyledText variant="subtitle1">Adddress</StyledText>
                  <StyledText variant="subtitle1">Creation Date:</StyledText>
                </div>
              </Grid>
