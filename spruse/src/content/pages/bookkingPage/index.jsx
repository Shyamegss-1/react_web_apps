...
const Index = () => {
									...
									if (el.status === 201) {
										...
										setTimeout(() => {
											window.location.href =
												"https://thetestingserver.com/Premium-Pro-Cleaners/commercial-cleaning/";
										}, 4000);
									}
								})
								.catch(err => {
	...
	useEffect(() => {
		if (servicetype !== null) {
			if (servicetype === "Residential-Cleaning") {
				setState("ROOMS");
			} else if (servicetype === "Commercial-Cleaning") {
				setState("SPACE");
			} else if (servicetype === "After-Event-Cleaning") {
				setState("EVENT");
			} else if (servicetype === "Move-in/Move-Out-Cleaning") {
				setState("INOUT");
			}
		}
	}, []);
								...
								<div className='row p-x'>
									<div className='col-md-12'>
										...
										<p>
											...
											booking, connect with us at +1 (850)754-1243.
										</p>
									</div>
